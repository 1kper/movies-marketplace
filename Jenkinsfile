...
node('workers'){
    ...
    stage('Push'){
          ...
          sh  "docker tag 1kper/movies-marketplace:latest .dkr.ecr.us-west-2.amazonaws.com/1kper/movies-marketplace:latest"
          sh  "docker push .dkr.ecr.us-west-2.amazonaws.com/1kper/movies-marketplace:latest"
